...
export default function Model(props) {
  ...
  useEffect(() => void (document.body.style.cursor = hovered ? "default" : "default"), [hovered])
  ...
  useFrame((state, delta) => {
    ...
    easing.damp3(halo.current.scale, hovered ? 1.15 : 2, 0.2, delta)
    easing.dampC(halo.current.material.color, hovered ? "#fff" : "#fff", 0.2, delta)
  })
